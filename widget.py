...
class Widget(QWidget):
    ...
    def __init__(self):
        ...
        answer_a = QRadioButton("A - What's your name?")
        answer_b = QRadioButton("B - How old are you?")
        answer_c = QRadioButton("C - How many brothers you have?")
